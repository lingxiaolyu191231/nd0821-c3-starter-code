...
def process_data(
    ...
    features and alabel binarizer for the labels. This can be used
    in either training orinference/validation.

    Note: depending on the type of model used, you may want to
    add in functionality thatscales the continuous data.
    ...
    label : str
        ...
        array will be returnedfor y (default=None)
    training : bool
